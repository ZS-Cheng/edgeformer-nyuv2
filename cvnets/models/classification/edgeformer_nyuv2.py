...
@register_cls_models("edgeformer_nyuv2")
class edgeformerNYUV2(BaseEncoder):
    """
        our proposed model
    """
    def __init__(self, opts, *args, **kwargs) -> None:
        ...
        channels = getattr(opts, "model.layer.channels", ['rgb', 'hha'])
        ...
        super(edgeformerNYUV2, self).__init__()
        self.dilation = 1
